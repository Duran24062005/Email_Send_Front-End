  ...
  return (
    <main className="relative isolate h-screen overflow-hidden">
      ...
      <div
        ...
        className="relative z-20 flex h-screen w-full overflow-x-auto overflow-y-hidden scroll-smooth snap-x snap-mandatory [&::-webkit-scrollbar]:hidden"
          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center px-0 leading-5">
              <h1 className="mb-8 text-balance text-5xl tracking-tight text-white [text-shadow:_0_4px_20px_rgb(0_0_0_/_60%)] md:text-6xl lg:text-8xl">
                <span className="font-open-sans-custom not-italic">Send Email.</span>{" "}
                <span className="font-serif italic">From Trinode.</span>{" "}
                <span className="font-open-sans-custom not-italic">Dev.</span>
              </h1>
